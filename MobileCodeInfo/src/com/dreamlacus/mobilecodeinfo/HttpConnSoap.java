...
public class HttpConnSoap {
	Context parent;
	public HttpConnSoap(Context context){
		parent=context;
	}
	public ArrayList<String> GetWebService(String methodName, ArrayList<String> Parameters, ArrayList<String> ParValues) {
		...
		//Service1.asmx是指提供服务的页面web/Service1.asmx
		String ServerUrl = "http://webservice.webxml.com.cn/WebServices/MobileCodeWS.asmx";
		

		String soapAction = "http://WebXml.com.cn/" + methodName;
		//String data = "";
		...
		mreakString = "<" + methodName + " xmlns=\"http://WebXml.com.cn/\">";
